...
namespace Nistor_Andreea_Lab2
{
    class DoughnutMachine : Component
    {
        ...
        public void MakeDoughnuts(DoughnutType dFlavor)//are rolul de a seta masina să creeze tipul corect
                                                       //de gogoașă, să seteze in mod corespunzător intervalul și să pornească masina.
        {
            Flavor = dFlavor;
            switch (Flavor)
            {
